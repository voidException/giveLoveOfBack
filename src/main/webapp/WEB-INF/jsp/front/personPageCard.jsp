...
<div class="container" style="margin-top: -8px;">
    ...
    <div class="row" style="background-color: #ffffff;height: 178px;">
        ...
        <div class="col-md-6">
            <div style="margin-top: 6px;"><span style="font-size: 20px;">æ¥æ :</span>2015-01-12å°2015-03-12

            </div>
            <div style="margin-top: 6px;"><span style="font-size: 20px;">ç®æ éé¢ :</span>10ä¸</div>
            <div style="margin-top: 6px;"><span style="font-size: 20px;">å®¡æ ¸å¢é :</span>åäº¬å¤§å­¦ç±å¿ç¤¾</div>
            <div style="margin-top: 6px;">
                <span style="font-size: 20px;" >æåµç®ä»:</span><p>å¼ ä¸ï¼ç·ï¼å±±ä¸å¾·å·äººï¼èº«ä»½è¯å·ï¼199955588514145415145151ï¼èº«æ£å¿èçï¼å®¶å¢è´«å¯ï¼å®å¨è´æä¸èµ·ï¼æ¿å¥½å¿äººå¸®å¿ä¸ä¸ï¼ä¸èææ¿</p>
            </div>
        </div>
    </div>
    ...
    <div class="row"><!--è¿éæ ¹æ®ä¸çº§æ é¢æ æ¾ç¤ºä¸åçç®å½-->
        <div class="col-md-2" style="border-right:1px solid #FDFFEA;height:200px;margin-left: -15px;">
            <ul class="list-group">
                ...
                <li class="list-group-item list-group-item-info">å¢å é¶è¡å¡</li>
                <li class="list-group-item list-group-item-warning">æ¯ä»å®è´¦å·</li>
            </ul>
        </div>
